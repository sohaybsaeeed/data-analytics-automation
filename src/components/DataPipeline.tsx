          ...
          <div className="hidden lg:block">
            <div className="flex items-start justify-between gap-4 mb-8">
              {stages.map((stage, index) => (
                <div key={stage.title} className="flex-1 flex flex-col items-center">
                  {/* Stage card */}
                  <Card className="w-full p-6 hover:shadow-xl transition-all duration-300 hover:-translate-y-2 bg-card border-border group cursor-pointer animate-fade-in"
                      ...
                      <div>
                        ...
                        <div className="space-y-1">
                          {stage.features.map((feature) => (
                            <div key={feature} className="text-xs text-muted-foreground flex items-center justify-center gap-1">
                  ...
                  {index < stages.length - 1 && (
                    <div className="absolute top-24 flex items-center" 
                      style={{ 
                      ...
                      <ArrowRight className="w-6 h-6 text-primary animate-pulse ml-2" 
          ...
          <div className="lg:hidden space-y-6">
            {stages.map((stage, index) => (
              <div key={stage.title} className="relative">
                <Card className="p-6 hover:shadow-xl transition-all duration-300 bg-card border-border animate-fade-in"
                  style={{ animationDelay: `${index * 100}ms` }}>
